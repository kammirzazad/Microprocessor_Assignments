  ...
  ;            CHOOSE : Chooses new brush mode based on the value of CX                             
       ...
       X_WHITE  EQU   0 ;   0 ; 0
       X_YELLOW EQU  80 ;  40 ; 1
       X_MAGEN  EQU 160 ;  80 ; 2
       X_RED    EQU 240 ; 120 ; 3 
       X_BLUE   EQU 320 ; 160 ; 4
       X_GREEN  EQU 400 ; 200 ; 5 
       X_GRAY   EQU 480 ; 240 ; 6
       X_BROWN  EQU 560 ; 280 ; 7
      ...
      CUR_STATE DB 0 ; 0->Brush / 1->Eraser
         ...
         STARTS DW X_WHITE , X_YELLOW , X_MAGEN , X_RED , X_BLUE , X_GREEN , X_GRAY , X_BROWN , X_MAX
         
         COLOR2 DW 0003H , 000AH , 000DH   ,   ?
         START2 DW    0  , X_AIR , X_ERASE , X_MAX
